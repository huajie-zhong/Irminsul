"""Unit tests for the source walk — the same-repo and siblings layouts."""
...
def walk_source_files(repo: Path, roots: list[str]) -> tuple[list[tuple[Path, str]], list[str]]:
    result = _walk(repo, roots=roots)
