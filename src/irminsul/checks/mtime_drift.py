...
class MtimeDriftCheck:
    ...
    explanations: ClassVar[dict[str, str]] = {
        ...
        CODE_DRIFT_DETECTED: (
            ...
            "the configured drift threshold. Re-read the doc against what the source now "
            "does and correct what is no longer true. Editing the doc for the sake of "
            "editing clears this signal without answering it."
        ),
    }
    classes: ClassVar[dict[str, FindingClass]] = {
        CODE_NO_GIT_HISTORY: FindingClass.certain,
        CODE_DRIFT_DETECTED: FindingClass.hint,
    }
