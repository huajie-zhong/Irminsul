"""RequirementGrammarCheck — structured review contracts on RFCs.
...
# Evidence classes shared with claim provenance.
...
def requirement_grammar_findings(
    ...
    Shared by the check (hints) and the transition planner (blockers)
...
def task_grammar_findings(
    ...
    *,
    ...
    """Grammar findings for one doc's `## Tasks` section.
...
class RequirementGrammarCheck:
    ...
    classes: ClassVar[dict[str, FindingClass]] = {
        "requirement-grammar/mixed-disposition": FindingClass.certain,
        "requirement-grammar/empty-requirements": FindingClass.certain,
        "requirement-grammar/missing-id": FindingClass.certain,
        "requirement-grammar/invalid-id": FindingClass.certain,
        "requirement-grammar/duplicate-id": FindingClass.certain,
        "requirement-grammar/missing-provenance": FindingClass.certain,
        "requirement-grammar/invalid-provenance": FindingClass.certain,
        "requirement-grammar/missing-behavior": FindingClass.certain,
        "requirement-grammar/missing-scenario": FindingClass.certain,
        "requirement-grammar/incomplete-scenario": FindingClass.certain,
        "requirement-grammar/task-missing-id": FindingClass.certain,
        "requirement-grammar/task-multiple-references": FindingClass.certain,
        "requirement-grammar/task-misplaced-reference": FindingClass.certain,
        "requirement-grammar/task-empty-reference": FindingClass.certain,
        "requirement-grammar/empty-tasks": FindingClass.certain,
        "requirement-grammar/task-duplicate-id": FindingClass.certain,
        "requirement-grammar/task-unresolved-req": FindingClass.certain,
        "requirement-grammar/task-unresolved-component": FindingClass.certain,
    }
    # The requirements contract is what acceptance freezes, so every one of these
    # reports an RFC that is not finished being written.
    drafts_exempt: ClassVar[frozenset[str]] = frozenset(classes)
